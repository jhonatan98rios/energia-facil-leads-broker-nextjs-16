      ...
      <div className="overflow-x-auto bg-white border rounded">
        <table className="w-full text-sm border-collapse text-gray-900">
          <thead className="bg-gray-100 text-gray-900">
            <tr>
              <th className="border px-3 py-2 text-left bg-yellow-50">Nome do responsável</th>
              <th className="border px-3 py-2 text-left bg-yellow-50">Cargo do responsável</th>
          ...
          <tbody className="text-gray-800">
            {leads.map((lead, index) => (
              <tr key={index} className="hover:bg-gray-50">
                <td className="border px-3 py-2 bg-yellow-50">{lead.contactName ?? '-'}</td>
                <td className="border px-3 py-2 bg-yellow-50">{lead.contactRole ?? '-'}</td>
                <td className="border px-3 py-2">{lead.companyName}</td>
                <td className="border px-3 py-2">{lead.cnpj}</td>
                <td className="border px-3 py-2">{lead.email}</td>
                <td className="border px-3 py-2">R$ {lead.averageBill.toLocaleString("pt-BR")}</td>
                <td className="border px-3 py-2 font-semibold">{lead.tier}</td>
                <td className="border px-3 py-2 max-w-md">{lead.classificationReason}</td>
                ...
                <td className="border px-3 py-2 whitespace-nowrap">{new Date(lead.createdAt).toLocaleString("pt-BR")}</td>
